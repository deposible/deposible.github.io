...
newtask(0.1, "InfWins", function()
    repetitive(100, function()
      game.ReplicatedStorage.RemotesMain.GiveDailyReward:FireServer("Medium Wins Pack", 1)
    end)
end)
newtask(0.1, "InfGems", function()
    repetitive(100, function()
      game.ReplicatedStorage.RemotesMain.UpdateGemStat:FireServer(1687.2, "p16")
    end)
end)
newtask(0.1, "InfPower", function()
    repetitive(100, function()
      game.ReplicatedStorage.RemotesMain.ClaimFreeGift:FireServer("Power 4", 1028, 0)
    end)
end)
newtask(0.1, "InfWins2", function()
    repetitive(100, function()
       game.ReplicatedStorage.RemotesMain.ClaimFreeGift:FireServer("Wins 3", 255, 0)
    end)
end)
